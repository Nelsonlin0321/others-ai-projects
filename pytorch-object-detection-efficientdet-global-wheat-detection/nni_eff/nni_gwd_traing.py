...
marking = pd.read_csv('/home/wlsh/ssd/kaggle/data/train.csv')
...
def get_train_transforms(tuner_params):
    return A.Compose(
        [
            ...
            A.OneOf([
                A.HueSaturationValue(hue_shift_limit=tuner_params['hue_shift_limit'],
                                     sat_shift_limit=tuner_params['sat_shift_limit'],
...
TRAIN_ROOT_PATH = '/home/wlsh/ssd/kaggle/data/train'
...
def get_net():
    ...
    # checkpoint = torch.load('/home/fuchunming/下载/fcm/efficientdet_d5-ef44aea8.pth')
